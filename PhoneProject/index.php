			...
			<div class="jumbotron">
				...
				<form class="navbar-form navbar-left" role="search" method="post" action="" >
				    <div class="form-group">
				        <input type="text"  name="search_text" value="<?=isset($_POST['search_text']) ? $_POST['search_text'] : ''?>" id="searchid" class="form-control input-lg" placeholder="Search for phone model">
				    </div>
